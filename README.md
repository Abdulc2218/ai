...
<head>
  ...
  <style>
    :root{
      ...
      --panel: #101218;          /* section panel */
      --card: #151827;           /* card surface */
      --muted: #a8b0c2;          /* secondary text */
      --text: #f5f7ff;           /* primary text */
      --accent: #8b5cf6;         /* violet */
      --accent-2: #b794f6;       /* light violet */
...
<body>
  ...
  <header>
    <div class="container nav">
      ...
      <div style="display:flex; gap:10px">
        <a href="#" class="btn btn-ghost">More Templates</a>
  ...
  <main>
    ...
    <section class="container hero">
      <div>
        <span class="badge">✨ New – AI‑assisted brand kits</span>
      ...
      <div class="hero-art">
        <div class="hero-swoosh" role="img" aria-label="Abstract purple fluid shape"></div>
